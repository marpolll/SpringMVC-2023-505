package com.marpol.hello.service.auth;
...
//		grantList.add(new SimpleGrantedAuthority("GUEST"));
		...
		// 마무리 한다.
		// security 에게 정상적인 사용자이니 login 절차를 마무리 하라 라는 의미
		return new UsernamePasswordAuthenticationToken(username, password, grantList);
	}

	// 현재 클래스를 authentication-manager 로 사용하겠다라는 선언
