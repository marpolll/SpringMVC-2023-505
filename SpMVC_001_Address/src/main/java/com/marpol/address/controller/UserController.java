package com.marpol.address.controller;
...
public class UserController {
	 ...
	 * 메뉴에서 login 을 실행하면 이 데이터는 null값 이다.
	 ...
	 * 이 프로젝트에서는 Session 을 관리자가 생성된다.
	 * 
	 * Session 은 http 프로토콜에서 Client 의 Server 간에 암묵적으로
	 * 데이터를 공유하는 통로가 만들어진다고 보면된다.
	 * 
	...
	public String logout(HttpSession httpSession) {
		...
		// Session 자체를 모두 소멸 이거 사용하자
		httpSession.removeAttribute("USER");

		return "redirect:/?message=LOGOUT";
		/*
		 * Controller.method() 에서 response 결과인 view 이름을 문자열로 return 하면 /WEB-INF/view/
