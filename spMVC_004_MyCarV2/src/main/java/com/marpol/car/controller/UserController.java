...
import com.marpol.car.service.UserService;

import lombok.extern.slf4j.Slf4j;

/*
 * class scope @RequestMapptin(type scope @RequestMapptin) 과
 * method scope @RequestMapptin 는 분리 되어있으나
...
public class UserController {
	...
	// localhost:8080/rootPath/user/login 으로 Requrst 되었을때
	// 호출되는 method
...
//		return UserDto.builder().build(); 아래랑 같음
		return new UserDto();
	}
